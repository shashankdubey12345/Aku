    ...
    <div className="py-12 px-4 w-full max-w-4xl mx-auto flex flex-col items-center select-none">
      ...
      >
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mt-2 text-xs md:text-sm italic">
          Close your eyes, make a wish in your heart, and tap blow!
        </p>
      </motion.div>

      {/* Cake Card */}
      <div className="w-full max-w-[325px] glass p-8 rounded-3xl flex flex-col items-center shadow-lg relative border border-pink-100 dark:border-white/5 overflow-hidden">
        ...
        {/* Cake Container SVG */}
        <div className="w-full h-64 flex items-end justify-center mb-6">
          ...
          <AnimatePresence mode="wait">
            {!isBlown ? (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={handleBlow}
                className="w-full flex items-center justify-center gap-2 py-3 px-6 bg-gradient-to-r from-rose-500 via-pink-500 to-purple-600 font-extrabold text-white text-sm rounded-full shadow-lg hover:shadow-xl shadow-rose-300 dark:shadow-none transition-all cursor-pointer"
              >
              ...
              >
                ...
                <button
                  onClick={handleReset}
                  className="px-4 py-1.5 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-500 dark:text-zinc-300 rounded-full text-xs font-bold transition-all border border-zinc-200 dark:border-zinc-700 cursor-pointer"
                >
                  Light Candle Again 🕯
                </button>
              </motion.div>
